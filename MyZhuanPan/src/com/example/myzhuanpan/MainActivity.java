...
public class MainActivity extends Activity implements OnClickListener {
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_begin:
			...
			if (!mTvToday.getText().toString().equals("请选择")
				...
				Toast.makeText(this, "请选择相应水果和注数", Toast.LENGTH_SHORT).show();
			}
			...
			if (msg.what == 1) {
				...
				if (mTvKaiJiang.getText().toString()
					...
					Toast.makeText(MainActivity.this,
							"恭喜您，中奖了！！！" + "共" + ZhongJiangMoney + "元", 0)
							.show();
					mTvDeFen.setText(ZhongJiangMoney + "");
					mTvToday.setText("请选择");
					mTvNowXiaZhu.setText("0");
				} else {
					Toast.makeText(MainActivity.this, "很遗憾，再来一次吧！", 0).show();
					mTvToday.setText("请选择");
					mTvNowXiaZhu.setText("0");
				}
